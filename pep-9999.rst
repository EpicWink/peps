...
.. code-block:: toml
        ...
        aiohttp = { version = ">= 3.6.2", extras = ["speedups"], markers = "python_version >= '3.8'", for-extras = ["http"] }
...
.. code-block:: toml
        ...
        aiohttp = { git = "git@github.com:aio-libs/aiohttp.git", revision = "master", extras = ["speedups"], markers = "python_version >= '3.8'", for-extras = ["http"] }
