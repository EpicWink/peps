...
.. code-block:: toml
        ...
        aiohttp = { vcs = "git", url = "git@github.com:aio-libs/aiohttp.git", revision = "master" }
...
.. code-block:: toml
        ...
        aiohttp = { version = ">= 3.6.2", for-extras = ["http"] }
...
.. code-block:: toml
        ...
        aiohttp = { version = ">= 3.6.2", extras = ["speedups"], for-extras = ["http"] }
...
.. code-block:: toml
        ...
        aiohttp = { vcs = "git", url = "git@github.com:aio-libs/aiohttp.git", revision = "master", extras = ["speedups"], for-extras = ["http"] }
